...
TARGETMAILGUNDOMAIN=${TARGETMAILGUNDOMAIN}
TARGETMAILGUNSECRET=${TARGETMAILGUNSECRET}
...
sudo sed -i "/MAILGUN_DOMAIN=/c\MAILGUN_DOMAIN=${TARGETMAILGUNDOMAIN}" .env
sudo sed -i "/MAILGUN_SECRET=/c\MAILGUN_SECRET=${TARGETMAILGUNSECRET}" .env
